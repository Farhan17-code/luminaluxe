...
import { useCart, useGlobalState } from '../contexts';

const CATEGORY_DATA = [
  {
    name: 'Electronics' as Category,
    image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=2070&auto=format&fit=crop',
    icon: Smartphone,
    desc: 'Cutting edge engineering'
  },
  {
...
export const ProductCard: React.FC<{ product: Product }> = ({ product }) => {
  ...
  // Track active state locally for instant preview
      ...
      <div className="flex flex-col space-y-0.5">
        <div className="flex justify-between items-start gap-2">
          ...
          <div className="flex items-center gap-1 shrink-0 pt-0.5">
            ...
            <span className="text-[11px] font-bold text-black leading-none">{product.review_count || 0}</span>
          </div>
        </div>
