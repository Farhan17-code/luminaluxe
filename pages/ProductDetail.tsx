                ...
                <div className="flex items-center gap-4 flex-wrap">
                  {product.variants.map((variant, i) => (
                    <button
                      ...
                      className={`w-9 h-9 rounded-full border-2 transition-all transform hover:scale-110 overflow-hidden ${selectedVariant?.color_name === variant.color_name ? 'border-black ring-2 ring-black ring-offset-2' : 'border-gray-100'}`}
